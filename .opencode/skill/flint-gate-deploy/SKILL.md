...
description: Deploy flint-gate via docker-compose or Kubernetes. Includes compose file, ConfigMap/Secret/Deployment/Service structure, probes, and env wiring. Use when the user says "deploy flint gate" or "flint gate kubernetes".
version: 0.1.0
license: MIT
---
